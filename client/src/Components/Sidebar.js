            ...
            {open ?
                ...
                <div style={{ width: "200px" }} className='h-screen bg-white z-10' onClick={handleClick}>
                    ...
                    <div className='flex flex-col w-full'>
                        ...
                        <div onClick={()=>{navigate('/contact')}} className='box-border rounded pl-3 py-3 w-full mt-2 flex flex-row text-lg font-medium rounded-md font-mono cursor-pointer text-black hover:p-1  hover:rounded-lg hover:text-white hover:bg-blue-500 hover:py-3'> <BsInfoCircle className='h-5 w-5 ml-1 mr-3' style={{ fill: 'black' }}/>Contact Us</div>
                    </div>
                </div> :
                 <div>
